// -------------------------------------------------------------------------------------------------
// Pin map for OnStep JTW PCB rev 2.1 STM32F411CE/STM32F401CE PCB (or the Blackpill https://github.com/WeActTC/MiniF4-STM32F4x1)
#pragma once
...
//     #define SERIAL_GPS_RX       PA12
//     #define SERIAL_GPS_TX       PA11
//   #endif
// #endif

// The multi-purpose pins (Aux3..Aux8 can be analog pwm/dac if supported)
#define AUX0_PIN                PB12             // Status LED
// #define AUX1_PIN                OFF              // TMC SPI MISO/Fault
#define AUX2_PIN                PC14             // PPS
// #define AUX3_PIN                OFF              // Home SW
// #define AUX4_PIN                OFF              // 1-Wire, Home SW
#define AUX5_PIN                PA9              // TX1 
#define AUX6_PIN                PA10             // RX1
// #define AUX7_PIN                OFF              // Limit SW
// #define AUX8_PIN                OFF              // Reticle LED, 1-Wire alternate
...
//    #define PPS_SENSE_PIN       OFF               // PPS time source, GPS for example (MaxSTM version 3.6)
//  #else
